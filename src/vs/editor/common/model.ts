...
export class TextModelResolvedOptions {
	...
	readonly skipSaveParticipantIds: string[];
	...
	constructor(src: {
		...
		this.skipSaveParticipantIds = src.skipSaveParticipantIds || [];
	}
	...
	public equals(other: TextModelResolvedOptions): boolean {
		return (
			...
			&& equals(this.skipSaveParticipantIds, other.skipSaveParticipantIds, (a, b) => a === b)
		);
	}
	...
	public createChangeEvent(newOpts: TextModelResolvedOptions): IModelOptionsChangedEvent {
		return {
			...
			skipSaveParticipantIds: !equals(this.skipSaveParticipantIds, newOpts.skipSaveParticipantIds, (a, b) => a === b),
		};
	}
}
